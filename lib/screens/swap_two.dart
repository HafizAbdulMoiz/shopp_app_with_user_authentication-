...
class SwapTwo extends StatelessWidget {
  const SwapTwo({ Key? key }) : super(key: key);
        ...
        children: [
         GestureDetector(
          onTap: (){
            Navigator.push(
    context,
    MaterialPageRoute(builder: (context) => const SwapThree()),
    );
          },
           child: Image.asset("assets/images/swaptwo.png",
           height: 800,
           width: 1500,
           fit: BoxFit.cover,
           ),
...
sweater collection''',style: TextStyle(color: Colors.white,fontSize: 18.0),)
),
